...
class Constants {
  ...
  static const Color colorPrimaryC = Color(0xff75BD23);
  static const Color colorSecondaryC = Color(0xff04448C);
  static const Color colorAlternativeC = Color(0xff357FB7);
  static const Color colorDefaultC = Color(0xffDFEEDF);
  static const Color colorDefaultTextC = Color(0xff3B5F11);
